...
def get_jobs(keyword, num_jobs, verbose):
    ...
    driver = webdriver.Chrome(executable_path="D:/Softwares/chromedriver", options=options)
        ...
        for job_button in job_buttons:  
            ...
            while not collected_successfully:
                try:
                    ...
                    job_description = driver.find_element_by_xpath('.//h2[@class="jobSectionHeader"]').text
